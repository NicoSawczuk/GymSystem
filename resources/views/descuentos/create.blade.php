...
@section('title') Agregar código de descuento @endsection
        ...
        <div class="col-md-8">
            <div class="card card-teal card-outline">
                <div class="card-header">
                    <h3 class="card-title"><i class="fal fa-edit"></i> Agregar código</h3>
                        ...
                        <div class="form-group row">
                            <div class="form-group col-md-4">
                                ...
                                <input id="codigo" type="text"
                                    ...
                                    value="{{ old('codigo') }}" placeholder="Ingrese el codigo">
                                @error('codigo')
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <input id="porcentaje_descuento" type="number"
                                    ...
                                    name="porcentaje_descuento" value="{{ old('porcentaje_descuento') }}"
                            ...
                            <div class="form-group col-md-4">
                                <label id="fecha_expiracionLabel" for="fecha_expiracion" class="col-form-label text-md-right">Fecha de
                                    expiración</label>
                                <input style="max-width: 80%" type="date" id="fecha_expiracion"
                                    ...
                                    value="{{ old('fecha_expiracion') }}" data-mask="" im-insert="false"
                        ...
                        <div class="form-group row">
                            <div class="form-group col-md-5">
                                ...
                                <textarea id="detalle" class="form-control  @error('detalle') is-invalid @enderror"
                                    rows="3" name="detalle" value="{{ old('detalle') }}"
                                    placeholder="Ingrese la descripción" required>{{ old('detalle') }}</textarea>
                                @error('detalle')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
