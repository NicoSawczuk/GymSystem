        ...
        <div class="">
            <div class="card card-teal card-outline">
                <div class="card-header">
                    <h3 class="card-title"><i class="fal fa-edit"></i> Roles y permisos de <strong>{{ $usuario->name }} {{ $usuario->apellido }}</strong></h3>
                        ...
                        <form method="POST" action="/usuarios/{{ $usuario->id }}">
                            ...
                            <div class="form-group row">
                                <div class="form-group">
                                    ...
                                    <select class="duallistbox" multiple="multiple" style="min-height: 250px" name="permisos[]">
