                  ...
                  <div class="modal-body">
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="card card-outline card-warning">
                          ...
                          <!-- /.card-header -->
                          <div class="card-body">
                            <p class="text-muted">Monto de <b id="nombreEspe"></b><span class="badge bg-warning"
                                id="montoEspe"></span></p>
                          </div>
                          <!-- /.card-body -->
                        </div>
                    ...
                    <div class="form-group row">
                      <div class="form-group col-md-3">
                        ...
                        <input id="monto_pagar" type="number" class="form-control @error('monto') is-invalid @enderror"
