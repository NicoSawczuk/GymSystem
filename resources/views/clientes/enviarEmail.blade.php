...
<body class="container">
    <form action="/clientes/{{ $cliente->id }}/enviar_email" method="POST">
    @csrf
    @method('POST')
    <div class="card card-teal card-outline">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control @error('destinatario') is-invalid @enderror" name="destinatario" value="{{ $cliente->email }}" placeholder="Ingrese un destinatario" disabled>
            @error('destinatario')
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control @error('asunto') is-invalid @enderror" name="asunto" value="{{ old('asunto') }}" placeholder="Ingrese un asunto" required>
            @error('asunto')
                <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
                </span>
          ...
          <div class="form-group">
            <label for="contenido" class="col-form-label text-md-right">Contenido</label>
              <textarea id="compose-textarea" name="contenido" class="form-control @error('contenido') is-invalid @enderror" required></textarea>
              @error('contenido')
                <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
                </span>
