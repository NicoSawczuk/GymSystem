    ...
    <div class="col-md-3">
        ...
        <div class="card-body box-profile">
          ...
          <ul class="list-group list-group-unbordered mb-3">
            <li class="list-group-item">
              <b>Gimnasio</b> <a class="float-right"><span
                  class="badge badge-pill bg-light">{{ $cliente->gimnasio->nombre }}</span></a>
            </li>
            @isset($cliente->especialidad)
            <li class="list-group-item">
              <b>Especialidad</b> <a class="float-right"><span
                  class="badge badge-pill bg-light">{{ $cliente->especialidad->nombre }}</span></a>
            </li>
            @endisset
            <li class="list-group-item">
          ...
          <a href="{{route('clientes.email',[$cliente->id,$cliente->slug()])}}" class="btn bg-teal btn-block"><b>Enviar
              E-mail</b></a>
          @if ($cliente->activo == 1)
      ...
      <div class="card card-teal">
        <div class="card-header">
          <h3 class="card-title">Últimos pagos ({{ $cliente->getUltimasTresCuotas()->count() }} de
            {{ $cliente->cuotas->count() }})</h3>
        </div>
        <!-- /.card-header -->
        <div class="card-body">
          ...
          <table class="table">
            <tbody>
              ...
              <head>
                ...
                <tr>
                  <th style="width:60%; text-align: left; margin-bottom: 1%; margin-top: 1%"
                    class="text-left text-muted">Monto a pagar:</th>
                  <td class="text-right">${{ $cuota->monto_cuota }}</td>
                </tr>
                <tr>
                  <th style="width:60%; text-align: left; margin-bottom: 1%; margin-top: 1%"
                    class="text-left text-muted">Monto pagado:</th>
          ...
          <div class="tab-content">
            <div class="active tab-pane" id="infoPersonal">
              ...
              <dl class="row" style="margin-left: 1%">
                ...
                <dd class="col-sm-8 text-muted">{{ \Carbon\Carbon::parse($cliente->fecha_nacimiento)->format('d/m/Y')}}
                  ({{ $cliente->getEdad() }} años)</dd>
              </dl>
              <dl class="row" style="margin-left: 1%">
              ...
              <dl class="row" style="margin-left: 1%">
                ...
                <dd class="col-sm-8 text-muted">
                  {{ \Carbon\Carbon::parse($cliente->getUltimaInscripcion()->fecha_inscripcion)->format('d/m/Y')}}</dd>
              </dl>
              <dl class="row" style="margin-left: 1%">
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <div class="callout callout-warning">
              ...
              <p>Esta a punto de dar de baja a {{$cliente->nombre}} {{$cliente->apellido}}, con esta acción no se podrán
                registrar pagos del cliente. Además, el sistema no controlará los pagos de sus cuotas</p>
            </div>
            ...
            <div class="callout callout-danger">
              ...
              <p>Ten en cuenta que el cliente tiene una deuda de <b>${{$cliente->getDeuda()}}</b>. Si no quieres saldar
                esa deuda, al momento de darlo de alta la podrás saldar</p>
            </div>
            @endif

            <div class="form-group">
              <label for="detalle" class=" col-form-label text-md-right">Detalle</label>
              <textarea id="detalle" class="form-control  @error('detalle') is-invalid @enderror" rows="3"
                name="detalle" value="{{ old('detalle') }}" placeholder="Ingrese el detalle de la baja"
          ...
          <div class="modal-body">
            ...
            <div class="form-group row">
              <div class="form-group col-md-3">
                ...
                <input id="monto" type="number" class="form-control @error('monto') is-invalid @enderror" name="monto"
                  step="0.01" value="{{ old('monto') }}" placeholder="$" min="1" pattern="^[0-9]+" required>
                @error('monto')
                <span class="invalid-feedback" role="alert">
                  <strong>{{ $message }}</strong>
                </span>
            ...
            <div class="form-group row">
              <div class="form-group col-md-7">
                <label for="detalle" class=" col-form-label text-md-right">Detalle</label>
                <textarea id="detalle" class="form-control  @error('detalle') is-invalid @enderror" cols="45" rows="2"
