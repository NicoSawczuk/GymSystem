              ...
              <tr>
                ...
                <td class="text-right" style="">
                  ...
                  <a role="button" class="" data-toggle="modal" href="#"
                    data-target="#modal-default-pagarDeuda-{{ $cliente->id }}" title="Saldar deuda">
                          ...
                          <div class="card-header">
                            ...
                            <div class="card-tools">
                              <button type="button" class="btn btn-tool" data-card-widget="collapse"
                                data-toggle="tooltip" title="Ocultar/Mostrar" style="margin-top: 1">
                        ...
                        <div class="card card-warning" style="width: 230px">
                          ...
                          <div class="card-body" style="margin-bottom: 0%;" id="montoDeudaCliente{{ $cliente->id }}">
                            <div class="row">
                              ...
                              <div class="col-md-1">
                                <span class="badge bg-warning text-right"
                                  style="margin-top: 3;">${{ $cliente->especialidad->monto }}</span>
                              </div>
                            </div>
                            <div class="row">
                              <div class="col-md-9">
                              ...
                              <div class="col-md-1">
                                <span class="badge bg-danger text-right"
                                  style="margin-top: 3;">${{ $cliente->getDeuda() - $cliente->especialidad->monto }}</span>
                              </div>
                            </div>
                            ...
                            <div class="row">
                              ...
                              <div class="col-md-1">
                                <span class="badge bg-info text-right"
                                  style="margin-top: 3;">${{ $cliente->getDeuda() }}</span>
                              </div>
                            </div>
                          </div>
                          <!-- /.card-body -->
